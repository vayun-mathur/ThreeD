...
HRESULT RayCastMaterial::Initialize(ID3D11Device* _device, int _windowWidth, int _windowHeight)
{
...
#pragma region Vertex Shader
	result = CompileShaderFromFile(L"./Assets/raycast.hlsl", "RayCastVS", "vs_5_0", &blob);
...
#pragma region Pixel Shader
	...
	result = CompileShaderFromFile(L"./Assets/raycast.hlsl", "RayCastPS", "ps_5_0", &blob);
